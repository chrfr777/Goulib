...
workdays
=========
:Id: $Id: workdays.py 2012-04-12 pgu $
:Author: Philippe Guglielmetti <drgoulu@gmail.com>
:Date: $Date: 2012-04$
:Copyright:  Open Source
:Description: date and time operations on restricted calendars
...
Imports
=======
- :py:mod:`datetime<python:datetime>`
...
class WorkCalendar:
    ...
    def __init__(self,worktiming,holidays=[],weekends=[SAT,SUN]):
        ...
        self._zero=timedelta(0) #useful "constant"
...
class TestCase(unittest.TestCase):
    def runTest(self):
        ...
        assert cal.workday(date2,-1) == date1, 'workday'
